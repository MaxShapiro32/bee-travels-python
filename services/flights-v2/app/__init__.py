from app.routes.flights import flights_blueprint
...
app.register_blueprint(flights_blueprint, url_prefix="/api/v1/flights")
    ...
    return jsonify(
        {
            ...
            "children": info_list,
            "language": "Python",
            "url": os.environ["Flights_V2_URL"]
            if "Flights_V2_URL" in os.environ
            else "http://localhost:9103",
        }
    )
